...
void start_i2c_dma_transmit_circular() {
    if (HAL_I2C_Slave_Transmit_DMA(&hi2c2, imu_data_buffer, sizeof(imu_data_buffer)) != HAL_OK) {
        // Handle Error
    }
}
...
void HAL_I2C_SlaveTxCpltCallback(I2C_HandleTypeDef *hi2c) {
    if (hi2c->Instance == I2C2) {
        // The data has been successfully transmitted.
        // In circular mode, the transmission will continue automatically.
        // You can modify tx_buffer content here for dynamic data updates.
    }
}

void HAL_I2C_ErrorCallback(I2C_HandleTypeDef *hi2c) {
    if (hi2c->Instance == I2C2) {
        // Handle error, possibly reset DMA and re-initiate the transmission
        start_i2c_dma_transmit_circular();
    }
}
